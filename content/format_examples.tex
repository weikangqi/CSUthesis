...
% LaTeX\citess{lamport1994latex}插入参考文献最方便的方式是使用bibliography\citess{pritchard1969statistical}，大多数出版商的论文页面都会有导出bib格式参考文献的链接，建议使用Jabref管理参考文献，把每个文献的bib放入``thesis-references''，然后用bibkey即可插入参考文献。
% 中文文献\citess{zh-book-1}，注意手动编辑bibkey为英文的即可。
% 可以将文献标注为右上角\citess{shiweisong2019},只需要在现有的cite后加“ss”即可。
% 英文会议\citess{Kraus2021Current}, \citess{WuYangLuEtAl2021}.
% 英文期刊\citess{LuoZengYuanEtAl2016}, \citess{Wu2022Boosting}.
